    ...
    invoke: async (name, params = {}) => {
      ...
      switch (name) {
        case 'Getproducts':
          return get('produtos');
        case 'fetchSQLData': {
          const sector = params?.sector && params.sector !== 'all' ? `?sector=${params.sector}` : '';
          return get(`produtos/lince-nao-cadastrados${sector}`);
        }
        case 'Getlossesreport':
        case 'getLossesReport':
          return post('perdas', params);
        case 'getSalesReport':
          return post('relatorio/vendas', params);
        case 'getReportData':
          return post('relatorio/dados', params);
        case 'getReportData_MULTIPERIOD':
          return post('relatorio/multiperiodo', params);
        case 'getDashboardData':
          return post('dashboard', params);
        case 'getPlanning':
        case 'Getplanningdata':
          return post('planejamento/dados', params);
        case 'savePlanning':
        ...
        case 'Createproduct':
          return post('produtos/criar', params);
        case 'Updateproduct':
          return post('produtos/atualizar', params);
        case 'Deleteproduct':
          return post('produtos/deletar', params);
        case 'getCatalogWithPricing':
          return get('produtos/catalogo');
        case 'updateProductPricing':
          return post('produtos/precos', params);
        case 'Debugplanning':
          return post('planejamento/debug', params);
        case 'diagnosticDB':
          return get('diagnostico');
        case 'getProductEvolution':
        case 'Getproductevolution':
          return post('relatorio/evolucao', params);
        case 'getProductMovementData':
